...
- **A mediated model boundary** — an OpenAI-compatible endpoint fronting hosted APIs and local engines, so model calls are inspected, budgeted and recorded exactly like tool calls.
